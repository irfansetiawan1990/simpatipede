                          ...
                          <form action="{{ route('Dosentetappt.store') }}" method="POST">
                            @csrf
                                  ...
                                  <div class="form-group">
                                      ...
                                      <input type="text" class="form-control" id="jabatan_akademik" name="waktu_durasi">
                                  </div>
                                  <div class="form-group">
  ...
  <div style="overflow-x:auto;">
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <td width="280px">{{ $item->matkul_ps_akreditasi}}</td>
            <td width="280px">{{ $item->kesesuaian_bid_keahlian}}</td>
            <td width="280px">{{ $item->matkul_diampu_pslain}}</td>
            <td width="100px">

              <!--modal edit -->
                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEdit{{ $item->id_dosen_tetap_pt }}">Edit</button>
                <div class="modal fade" id="modalEdit{{ $item->id_dosen_tetap_pt }}" tabindex="-1" aria-labelledby="modalEdit1" aria-hidden="true">
                           <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                  <div class="modal-content">
                    <div class="modal-header">
                    ...
                    <!--FORM TAMBAH PS-->
                                ...
                                <form action="{{ route('Dosentetappt.update',$item->id_dosen_tetap_pt) }}" method="POST">
                            @csrf
                            @method('PUT')
                                  ...
                                  <div class="form-group">
                                   ...
                                   <div class="form-group">
                                      <label for="">Mata Kuliah yang Diampu pada PS yang Diakreditasi</label>
                                      <input type="text" class="form-control" id="matkul_ps_akre" name="matkul_ps_akre" value="{{$item->matkul_diampu_pslain}}">
                                  </div>
                                   <div class="form-group">
                                      <label for="">Kesesuaian Bidang Keahlian</label>
                    ...
                    <form action="{{ route('Dosentetappt.destroy',$item->id_dosen_tetap_pt) }}" method="POST">
                    @csrf
                    @method('DELETE')
